...
# Project Overview
Industrial Surface Crack Detection using Convolutional Neural Networks (CNN) is a computer vision-based quality inspection system designed to automatically identify cracks on industrial surfaces. The system uses deep learning techniques to classify images into two categories:
Crack
No Crack
...
The project supports prediction on a single image.
Example workflow : predict_single_image("sample_crack.jpg")
Output : Single Image Prediction
...
cd Industrial_Surface_Crack_Detection
